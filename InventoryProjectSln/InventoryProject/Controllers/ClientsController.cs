...
namespace InventoryProject.Controllers
{
    public class ClientsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ClientID,ClientName,Address,DistrictID,ContactNo,Email,ClientOpnBalance,ClientType,TrDate")] Client client)
        {
            if (ModelState.IsValid)
            {
        ...
        public JsonResult GetClient()
        {
            ...
            var jsonData = client.Select(x => new {x.ClientID, x.ClientName });
